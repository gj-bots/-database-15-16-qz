...
--
-- Host: localhost
-- Generation Time: Jun 17, 2023 at 08:38 AM
...
CREATE TABLE `bahan_baku_menu` (
  ...
  `nama_bahan` varchar(75) NOT NULL,
  `jumlah` int NOT NULL,
  `satuan` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `bahan_baku_menu` (`nama_menu`, `nama_bahan`, `jumlah`, `satuan`) VALUES
...
INSERT INTO `karyawan` (`Id`, `Nama`, `TglLahir`, `No_KTP`, `Posisi`) VALUES
...
INSERT INTO `koki` (`id`, `sertifikasi`) VALUES
('16902', 'Pastry'),
('16903', 'Fry'),
('16904', 'Pastry'),
('16909', 'Fry'),
...
INSERT INTO `menu` (`nama`, `harga`, `id_kategori`) VALUES
...
INSERT INTO `menu_harian` (`nama_menu`, `tanggal`, `id_koki`, `jumlah`) VALUES
...
INSERT INTO `pembelian_bahan_baku` (`nota`, `nama_bahan`, `jumlah`, `satuan`, `harga_satuan`, `waktu`, `id_supplier`, `id_karyawan`) VALUES
...
INSERT INTO `supplier` (`id`, `nama`, `telepon`, `email`) VALUES
...
ALTER TABLE `bahan_baku_menu`
  ADD PRIMARY KEY (`nama_menu`,`nama_bahan`),
...
ALTER TABLE `menu_harian`
  ADD PRIMARY KEY (`nama_menu`,`tanggal`,`id_koki`),
  ADD KEY `id_koki` (`id_koki`),
  ADD KEY `id_koki_2` (`id_koki`),
  ADD KEY `nama_menu` (`nama_menu`);
...
--
ALTER TABLE `bahan_baku_menu`
  ADD CONSTRAINT `bahan_baku_menu_ibfk_1` FOREIGN KEY (`nama_bahan`) REFERENCES `bahan_baku` (`nama`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `bahan_baku_menu_ibfk_2` FOREIGN KEY (`nama_menu`) REFERENCES `menu` (`nama`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `koki`
--
ALTER TABLE `koki`
  ADD CONSTRAINT `koki_ibfk_1` FOREIGN KEY (`id`) REFERENCES `karyawan` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `menu_harian`
  ADD CONSTRAINT `menu_harian_ibfk_2` FOREIGN KEY (`nama_menu`) REFERENCES `menu` (`nama`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `menu_harian_ibfk_3` FOREIGN KEY (`id_koki`) REFERENCES `koki` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `pembelian_bahan_baku`
--
ALTER TABLE `pembelian_bahan_baku`
  ADD CONSTRAINT `pembelian_bahan_baku_ibfk_3` FOREIGN KEY (`nama_bahan`) REFERENCES `bahan_baku` (`nama`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `pembelian_bahan_baku_ibfk_4` FOREIGN KEY (`id_supplier`) REFERENCES `supplier` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `pembelian_bahan_baku_ibfk_5` FOREIGN KEY (`id_karyawan`) REFERENCES `karyawan` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
